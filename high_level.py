...
class DQN(object):
    def __init__(self, args):  # 定义DQN的一系列属性
        ...
        # get the path of the result to save the model
        ...
        # set the max holding number for different dataset
        # max holding number is the maximum number of the asset that the agent can hold
        ...
        # the subagents are used to calculate the Q value of the state
        ...
        # define the hyperagent
        # the hyperagent is used to combine the output of the subagents
        # the hyperagent is used to calculate the final action
    ...
    def update(self, replay_buffer):
        ...
        # calculate the Q value of the current state and the next state
        qs_current = [
    ...
    # act_test is used to test the model
    ...
    # q_estimate is used to estimate the Q value of the state
    # the Q value is used to calculate the hidden state of the hyperagent
    ...
    # calculate_hidden is used to calculate the hidden state of the hyperagent
    # the hidden state is used to calculate the Q value of the state
...
if __name__ == "__main__":
    ...
    agent = DQN(args)
    agent.train()
    data = np.load('./result/high_level/ETHUSDT/val/final_balance_val.npy')
    print(data)